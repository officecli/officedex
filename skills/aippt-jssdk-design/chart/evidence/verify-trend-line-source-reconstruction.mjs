...
const REFERENCE_PATH = path.join(
  REPO_ROOT,
  "sampleall/chart/基础属性/折线图/折线图/幻灯片20.png",
);
const OUTPUT_BASE = path.join(
  OFFICEDEX_ROOT,
  "build/aippt-chart-source-evidence/trend-line-source-reconstruction",
);
...
const FACTS = path.join(
  OFFICEDEX_ROOT,
  "skills/aippt-jssdk-design/chart/evidence/trend-line-source-reconstruction.json",
);
...
try {
  ...
  const facts = {
    id: "trend-line-source-reconstruction",
    family: "chart_trend",
    source:
    ...
    verification:
      "skills/aippt-jssdk-design/chart/evidence/trend-line-source-reconstruction.verification.json",
    observed_items: 3,
    mechanism: "native-line-chart-default-style",
    source_fact:
      "白底 16:9 画布中央放置原生折线图，标题居中，顶部图例，四类目三系列平滑折线。",
    transfer_hypothesis:
      "保留原生折线图、标题、顶部图例和四类目轴向关系；自由页面可在外层增加结论区，但不能把趋势图退化为装饰线。",
