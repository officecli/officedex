import { Dropdown, Form, Image, InputNumber, message, Modal, Popover, Progress, Radio, Space, Tag, Timeline, type MenuProps } from "antd";
import { Button, Spin, Tooltip } from "@vo-ui/backend";
import {
  CheckCircleFilled,
  CheckCircleOutlined,
  CloseCircleFilled,
