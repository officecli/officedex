...
export function Popover({ content, children, open, placement = "bottom", onOpenChange }: PopoverProps) {
  ...
  return (
    <>
      ...
      {visible ? createPortal(
        <div className="ui-popover" ref={panelRef} role="dialog" style={style}>{content}</div>,
        document.body,
      ) : null}
    </>
  );
