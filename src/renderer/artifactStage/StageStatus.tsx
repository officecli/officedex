...
export type ArtifactStageStatus = "pending" | "running" | "completed" | "failed" | "cancelled";
...
export function ArtifactStageStatusBanner({ status, message, error, onCancel, onRetry, className }: ArtifactStageStatusProps) {
