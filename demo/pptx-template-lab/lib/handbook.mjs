...
function purposeFor(pageKind, cardCount) {
  const map = {
    ...
    partners: "Fill the partners heading. Partner name slots: only names listed in the brief; otherwise 合作伙伴一/二/三 — never invent famous brands.",
    pricing: "Fill pricing heading and each plan slot with name + price + 2-4 short features matching the sample density. Do not leave a tall card with only a title.",
