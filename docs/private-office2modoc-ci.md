...
repository under `vendor/office2modoc-ffi/0.1.34/<target>/`. The public
...
- `OFFICECLI_INTERNAL_REF`: branch, tag, or commit containing the vendor tree.
...
Windows targets are available in the private vendor tree for future jobs.
